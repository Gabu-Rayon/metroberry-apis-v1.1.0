...
class DriverAppController extends Controller
{
    ...
    public function license(Request $request)
    {
        try {
            ...
            $frontLicenseDirectory = 'public_html_metroberry_app/uploads/front-license-pics';
            $backLicenseDirectory = 'public_html_metroberry_app/uploads/back-license-pics';
    ...
    public function psvBadgeCreate(Request $request)
    {
        try {
            ...
            $psvBadgeDirectory = 'public_html_metroberry_app/uploads/psvbadge-avatars';
    ...
    public function updateProfilePicture(Request $request)
    {
        ...
        if ($request->hasFile('profile_picture')) {
            ...
            if ($driver->user->avatar) {
                $oldProfilePath = 'public_html_metroberry_app/' . $driver->user->avatar;
