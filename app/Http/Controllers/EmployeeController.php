    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($request->hasFile('avatar')) {
                ...
                $avatarFile->move('./public_html_metroberry_app/user-avatars', $avatarFileName);
            ...
            if ($request->hasFile('front_page_id')) {
                ...
                // Move the new file to the specified directory
                $frontIdFile->move('./public_html_metroberry_app/front-page-ids', $frontIdFileName);
            ...
            if ($request->hasFile('back_page_id')) {
                ...
                // Move the new file to the specified directory
                $backIdFile->move('./public_html_metroberry_app/back-page-ids', $backIdFileName);
