...
class VehicleInsuranceController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('policy_document')) {
                $file = $request->file('policy_document');
                $fileName = time() . '_' . $file->getClientOriginalName();
                $directory = 'public_html_metroberry_app/uploads/vehicle_insurance_policy_document/';
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('policy_document')) {
                $file = $request->file('policy_document');
                $filename = time() . '_' . $file->getClientOriginalName();
                $directory = 'public_html_metroberry_app/uploads/policy_documents/';
                ...
                // Delete old policy document if it exists
                if ($vehicleInsurance->policy_document) {
                    $oldFilePath = 'public_html_metroberry_app/' . $vehicleInsurance->policy_document;
                    if (file_exists($oldFilePath)) {
                        unlink($oldFilePath);
                    }
                }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            // Delete old policy document if it exists
            if ($insurance->policy_document) {
                $filePath = 'public_html_metroberry_app/' . $insurance->policy_document;
                if (file_exists($filePath)) {
                    unlink($filePath);
                }
            }
    ...
    public function renewPost($id, Request $request)
    {
        try {
            ...
            if ($request->hasFile('policy_document')) {
                ...
                // Delete old policy document if it exists
                if ($insurance->policy_document) {
                    $oldFilePath = 'public_html_metroberry_app/' . $insurance->policy_document;
                    if (file_exists($oldFilePath)) {
                        unlink($oldFilePath);
                    }
                }
