      ...
      var a = i(5125),
            ...
            Object.defineProperty(t.prototype, "setupDefaultRules", {
              ...
              value: function () {
                ...
                i("PercentSeries").setAll({
                  ...
                  i("Slice", ["pie"]).states.create("hover", { scale: 1.04 }),
                  ...
                  i("Tick", ["funnel"]).setAll({ location: 1 }),
                  ...
                  i("PyramidSeries").setAll({ valueIs: "area" }),
                  ...
                  i("Tick", ["pyramid"]).setAll({ location: 1 }),
                  ...
                  i("Tick", ["pictorial"]).setAll({ location: 0.5 });
                var a = i("Graphics", ["pictorial", "background"]);
                a.setAll({ fillOpacity: 0.2 }),
            ...
            return (
              Object.defineProperty(t, "slicesContainer", {
                ...
                value: t.children.push(
                  b.W.new(t._root, { position: "absolute", isMeasured: !1 })
                ),
              }),
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "makeTick", {
              ...
              value: function (e) {
                ...
                return (
                  t._setDataItem(e), e.set("tick", t), this.ticks.push(t), t
                );
              },
            }),
            Object.defineProperty(t.prototype, "_afterNew", {
              ...
              value: function () {
                if (
                  ...
                  f.each(this._dataItems, function (e) {
                    ...
                    this.setPrivateRaw("valueLow", r),
                    this.setPrivateRaw("valueHigh", a),
                    this.setPrivateRaw("valueSum", t),
                    this.setPrivateRaw("valueAverage", t / n),
                    this.setPrivateRaw("valueAbsoluteSum", i);
                }
              },
            }),
                ...
                return (0, a.mG)(this, void 0, void 0, function () {
                  ...
                  return (0, a.Jh)(this, function (a) {
                    switch (a.label) {
                      case 0:
                        return (
                          (i = []).push(e.prototype.show.call(this, t)),
                ...
                return (0, a.mG)(this, void 0, void 0, function () {
                  ...
                  return (0, a.Jh)(this, function (a) {
                    switch (a.label) {
                      case 0:
                        return (
                          (i = []).push(e.prototype.hide.call(this, t)),
                      ...
                      case 0:
                        return (
                          ...
                          (s = t.animate({
                            ...
                            duration: i,
                            easing: n,
                          })) && r.push(s.waitForStop()),
                          (o = t.get("tick")) && r.push(o.show(i)),
                          (u = t.get("label")) && r.push(u.show(i)),
                          (c = t.get("slice")) && r.push(c.show(i)),
                          [4, Promise.all(r)]
                        );
                      case 1:
                        return a.sent(), [2];
                    ...
                    switch (a.label) {
                      case 0:
                        return (
                          ...
                          (o = t.get("tick")) && r.push(o.hide(i)),
                          (u = t.get("label")) && r.push(u.hide(i)),
                          (c = t.get("slice")).hideTooltip(),
                          c && r.push(c.hide(i)),
                          [4, Promise.all(r)]
                        );
                      case 1:
        ...
        m = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_afterNew", {
              ...
              value: function () {
                e.prototype._afterNew.call(this),
                  this.seriesContainer.setAll({ x: l.CI, y: l.CI });
              },
            }),
            Object.defineProperty(t.prototype, "_prepareChildren", {
              enumerable: !1,
              ...
              value: function () {
                ...
                if (s instanceof l.gG) {
                  var b = s.value,
                    p = Math.min(u, c);
                  (b = Math.max(p * b, p - Math.min(a, i)) / p),
                    (h = v.getArcBounds(0, 0, r, n, b)),
                    this.setPrivateRaw("irModifyer", b / s.value);
                }
                o = v.mergeBounds([o, h]);
                var f = this._maxRadius;
                this._maxRadius = Math.min(u, c);
                var d = y.relativeToValue(
                  this.get("radius", 0),
                  this._maxRadius
                );
          ...
          return (
              ...
              value: function () {
                ...
                return new k.o(_.YS.new({}), function () {
                  return P.d._new(
                    ...
                    {
                      themeTags: y.mergeTags(
                        e.ticks.template.get("themeTags", []),
                        ["pie", "series"]
                      ),
                    },
                    [e.ticks.template]
                ...
                if (i) {
                  if (this.isDirty("alignLabels")) {
                    ...
                    this.get("alignLabels")
                      ? a.set("textType", "aligned")
                      : null == a.get("textType") &&
                        a.set("textType", "adjusted");
                  }
                  if (
                    this._valuesDirty ||
                    this.isDirty("radius") ||
                        ...
                        f.each(this._dataItems, function (e) {
                          ...
                          if (a) {
                            a.set("radius", o),
                              ...
                              a.set("arc", i);
                            var r = e.get("fill");
                            a._setDefault("fill", r),
                              a._setDefault("stroke", r);
                          }
                          var c = v.normalizeAngle(s + i / 2),
                            h = e.get("label");
                          if (
                            h &&
                            (h.setPrivate("radius", o),
                            h.setPrivate("innerRadius", u),
                            h.set("labelAngle", c),
                            ...
                            c > 90 && c <= 270
                              ? (h.isHidden() ||
                                  h.isHiding() ||
                                  t._lLabels.push({ label: h, y: p }),
                                (b *= -1),
                                (b -= t.labelsContainer.get("paddingLeft", 0)),
                                h.set("centerX", l.AQ),
                                h.setPrivateRaw("left", !0))
                              : (h.isHidden() ||
                                  h.isHiding() ||
                                  t._rLabels.push({ label: h, y: p }),
                                (b += t.labelsContainer.get("paddingRight", 0)),
                                h.set("centerX", 0),
            ...
            Object.defineProperty(t.prototype, "_updateTick", {
              ...
              value: function (e) {
                ...
                if (t && i && a) {
                  var n =
                      (a.get("shiftRadius", 0) + a.get("radius", 0)) *
                      a.get("scale", 1) *
                      r,
                    ...
                    p = 0;
                  if (
                    ((b = i.x()), (p = i.y()), "circular" == i.get("textType"))
                  ) {
        ...
        j = (function (e) {
          function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
              Object.defineProperty(t, "_projectionDirty", {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: !1,
              ...
              value: function () {
                ...
                e.prototype._afterNew.call(this),
                  this.set("draw", function (e) {
                    e.moveTo(t._tlx, t._tly),
                      e.lineTo(t._trx, t._try),
                      e.quadraticCurveTo(t._cprx, t._cpry, t._brx, t._bry),
                      e.lineTo(t._blx, t._bly),
                      e.quadraticCurveTo(t._cplx, t._cply, t._tlx, t._tly);
                  });
              },
            }),
                ...
                if (
                  ...
                  "vertical" == this.get("orientation")
                    ? ((this._tlx = -a / 2),
                      ...
                      (this._bly = i),
                      (this._cprx =
                        this._trx + (this._brx - this._trx) / 2 + n * i),
                      (this._cpry = this._try + 0.5 * i),
                      (this._cplx =
                        this._tlx + (this._blx - this._tlx) / 2 - n * i),
                      (this._cply = this._tly + 0.5 * i))
                    : ((this._tly = -a / 2),
                      (this._tlx = 0),
                      (this._try = a / 2),
                      (this._trx = 0),
                      ...
                      (this._blx = t),
                      (this._cpry =
                        this._try + (this._bry - this._try) / 2 + n * t),
                      (this._cprx = this._trx + 0.5 * t),
                      (this._cply =
                        this._tly + (this._bly - this._tly) / 2 - n * t),
                      (this._cplx = this._tlx + 0.5 * t));
                }
          ...
          return (
                ...
                return new k.o(_.YS.new({}), function () {
                  return j._new(
                    e._root,
                    {
                      themeTags: y.mergeTags(
                        e.slices.template.get("themeTags", []),
                        [e._tag, "series", "slice", e.get("orientation")]
                      ),
                    },
                    [e.slices.template]
                  );
                ...
                return new k.o(_.YS.new({}), function () {
                  return C._._new(
                    e._root,
                    {
                      themeTags: y.mergeTags(
                        e.labels.template.get("themeTags", []),
                        [e._tag, "series", "label", e.get("orientation")]
                      ),
                    },
                    [e.labels.template]
                  );
                ...
                return new k.o(_.YS.new({}), function () {
                  return P.d._new(
                    e._root,
                    {
                      themeTags: y.mergeTags(
                        e.ticks.template.get("themeTags", []),
                        [e._tag, "series", "tick", e.get("orientation")]
                      ),
                    },
                    [e.ticks.template]
                  );
              ...
              value: function () {
                ...
                return new k.o(_.YS.new({}), function () {
                  return j._new(
                    ...
                    {
                      themeTags: y.mergeTags(
                        e.links.template.get("themeTags", []),
                        [e._tag, "series", "link", e.get("orientation")]
                      ),
                    },
                    [e.links.template]
                  );
            ...
            Object.defineProperty(t.prototype, "makeLink", {
              ...
              value: function (e) {
                ...
                return (
                  t._setDataItem(e), e.set("link", t), this.links.push(t), t
                );
              },
            }),
            Object.defineProperty(t.prototype, "_afterNew", {
            ...
            Object.defineProperty(t.prototype, "_updateChildren", {
              ...
              value: function () {
                ...
                var i = 0,
                  a = 0;
                if (
                  (f.each(this.dataItems, function (e) {
                    var r = e.get("value");
                    d.isNumber(r) &&
                      (a++,
                      r > 0
                        ? (i += Math.abs(e.get("valueWorking", r) / r))
                        : t.get("ignoreZeroValues", !1) || e.isHidden()
                        ? a--
                        : (i += 1));
                  }),
                  (this._total = (1 / a) * i),
                  ...
                  (r =
                    "vertical" == this.get("orientation")
                      ? n.innerHeight()
                      : n.innerWidth()),
                    (this._nextCoord = this.get("startLocation", 0) * r),
                    this.markDirtyBounds();
                  var l = 0;
                  f.each(this._dataItems, function (e) {
                    ...
                    var i = e.get("slice"),
                      ...
                      n = e.get("link"),
                      s = e.get("fill");
                    i._setDefault("fill", s),
                      i._setDefault("stroke", s),
                      n._setDefault("fill", s),
                      n._setDefault("stroke", s);
                    var o = e.get("value");
                    d.isNumber(o) &&
                      (0 == o && t.get("ignoreZeroValues")
                        ? (i.setPrivate("visible", !1),
                          a.setPrivate("visible", !1),
                          r.setPrivate("visible", !1))
                        : (i.setPrivate("visible", !0),
                          a.setPrivate("visible", !0),
                          r.setPrivate("visible", !0),
                          t.decorateSlice(e),
                          t.isLast(e)
                            ? n.setPrivate("visible", !1)
                            : e.isHidden() || n.setPrivate("visible", !0)));
                  });
                }
                e.prototype._updateChildren.call(this);
              },
              ...
              value: function () {
                ...
                this.get("alignLabels")
                  ...
                  : (t.setAll({ isMeasured: !1, position: "absolute" }),
                    "vertical" == e
                      ? (t.setAll({ x: l.CI }),
                        i.setAll({ centerX: l.CI, x: 0 }))
                      : (t.setAll({ y: l.CI }),
                        i.setAll({ centerX: l.CI, y: 0 }))),
                  this.markDirtySize();
              },
            }),
            Object.defineProperty(t.prototype, "getNextValue", {
              ...
              value: function (e) {
                ...
                if (t < this.dataItems.length - 1) {
                  ...
                  if (
                    ((i = a.get("valueWorking", 0)),
                    a.isHidden() ||
                      (0 == a.get("value") && this.get("ignoreZeroValues")))
                  )
                    return this.getNextValue(a);
                }
                return i;
              },
            }),
            ...
            Object.defineProperty(t.prototype, "decorateSlice", {
              ...
              value: function (e) {
                ...
                var u = this.getNextValue(e),
                  ...
                  f = 1;
                0 != c ? (f = h / Math.abs(c)) : e.isHidden() && (f = 1e-6),
                  this._nextCoord == 1 / 0 && (this._nextCoord = 0);
                var d = (h / p) * o,
                  g = ((h - (h - u) * b) / p) * o;
                i.setAll({ topWidth: d, bottomWidth: g, orientation: t }),
                  r.setAll({
                    topWidth: g,
                ...
                if ("vertical" == t) {
                  (s = s * (v - y) + (w = r.height() * f)),
                    i.set("y", this._nextCoord);
                  var m = Math.min(
                    1e5,
                    Math.max(0, ((s / this._count) * f) / this._total - w)
                  );
                  i.setAll({ height: m, x: l / 2 });
                  var _ = this._nextCoord + m / 2;
                  a.set("y", _),
                    (this._nextCoord += m + w),
                    r.setAll({ y: this._nextCoord - w, x: l / 2 });
                } else {
                  var w;
                  (l = l * (v - y) + (w = r.width() * f)),
                    i.set("x", this._nextCoord);
                  var P = Math.min(
                    1e5,
                    Math.max(0, ((l / this._count) * f) / this._total - w)
                  );
                  i.setAll({ width: P, y: s / 2 });
                  var x = this._nextCoord + P / 2;
                  a.set("x", x),
                    (this._nextCoord += P + w),
                    r.setAll({ x: this._nextCoord - w, y: s / 2 });
                }
              },
            }),
            Object.defineProperty(t.prototype, "hideDataItem", {
              ...
              value: function (t, i) {
                return (0, a.mG)(this, void 0, void 0, function () {
                  return (0, a.Jh)(this, function (a) {
                    return (
                      t.get("link").hide(i),
                      [2, e.prototype.hideDataItem.call(this, t, i)]
                    );
                  });
                });
              },
              ...
              value: function (t, i) {
                return (0, a.mG)(this, void 0, void 0, function () {
                  return (0, a.Jh)(this, function (a) {
                    return (
                      t.get("link").show(i),
                      [2, e.prototype.showDataItem.call(this, t, i)]
                    );
                  });
                });
              },
            ...
            Object.defineProperty(t.prototype, "decorateSlice", {
              ...
              value: function (e) {
                ...
                if (0 != p) {
                  ...
                  var T = O / 2,
                    A = 1;
                  0 != x ? (A = P / Math.abs(x)) : e.isHidden() && (A = 1e-6),
                    (k =
                      k * (m - v) - (C *= A) * (this._count * this._total - 1));
                  ...
                  "vertical" == s
                    ? (c.set("y", W),
                      c.get("opacity") > 0 &&
                        this._rLabels.push({ label: c, y: W }),
                      u.set("height", f))
                    : (c.set("x", W),
                      c.get("opacity") > 0 &&
                        this._hLabels.push({ label: c, y: W }),
                      (z = (r = (0, a.CR)([H, z], 2))[0]),
                      (H = r[1]),
                      (V = (n = (0, a.CR)([F, V], 2))[0]),
                      (F = n[1]),
            ...
            Object.defineProperty(t.prototype, "_updateScale", {
              ...
              value: function () {
                var e = this.slicesContainer,
                  ...
                  s = l.right - l.left,
                  o = l.bottom - l.top;
                (n = "horizontal" == this.get("orientation") ? t / s : i / o) !=
                  1 / 0 &&
                  NaN != n &&
                  (a.set("scale", n),
                  a.set("x", t / 2),
            ...
            Object.defineProperty(t.prototype, "_prepareChildren", {
              ...
              value: function () {
                if (
                  ...
                  this.seriesMask.set("svgPath", t),
                    this.seriesGraphics.set("svgPath", t);
                }
                this._updateScale();
              },
            }),
