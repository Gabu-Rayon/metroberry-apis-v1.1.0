                  ...
                  if (h / y > n / 2 + o.y) {
                    ...
                    b.each(l, function (e) {
                      ...
                      i instanceof u.gG && (t *= i.value),
                        ...
                        (_ = Math.min(_ - t, e._fy - t)),
                        v.children.moveValue(e, 0);
                    });
                  } else {
                    l.reverse(),
                      l.sort(function (e, t) {
                  ...
                  if ("none" != t) {
                    ...
                    if (
                      (("zoomX" !== t &&
                        ...
                        "selectX" !== t &&
                        "selectXY" !== t) ||
                        (Math.abs(a - this.getPrivate("downPositionX", 0)) >
                          0.003 &&
                          (o = !0)),
                      ("zoomY" !== t &&
                        "zoomXY" !== t &&
                        "selectY" !== t &&
                        "selectXY" !== t) ||
                        (Math.abs(n - this.getPrivate("downPositionY", 0)) >
                          0.003 &&
                          (o = !0)),
                      o)
                    ) {
            ...
            Object.defineProperty(t.prototype, "_updateGhost", {
              ...
              value: function () {
                ...
                var a = this.get("start", 0),
                  r = this.get("end", 1);
                this.get("renderer").updateLabel(e, a + 0.5 * (r - a));
              },
            }),
            Object.defineProperty(t.prototype, "_handleCursorPosition", {
              enumerable: !1,
              ...
              value: function () {
                ...
                if (this.isDirty(i) || this.isDirty(a)) {
                  var r,
                    n = this.chart,
                    o = t.children;
                  this.get(a) ? t.addTag(a) : t.removeTag(a),
                    n &&
                      (this.get(i)
              ...
              value: function () {
                ...
                if (this.isDirty(a) || this.isDirty(r)) {
                  var o,
                    s = this.chart,
                    l = t.children;
                  this.get(r) ? t.addTag(r) : t.removeTag(r),
                    s &&
                      (this.get(a)
                        ? (-1 ==
                            (o = s.rightAxesContainer.children).indexOf(t) &&
                            o.moveValue(t, 0),
                          t.addTag(a),
                          l.moveValue(this, 0),
                          i.set("centerX", 0))
                        : (-1 ==
                            (o = s.leftAxesContainer.children).indexOf(t) &&
                            o.moveValue(t),
                          t.removeTag(a),
                          l.moveValue(this),
                          i.set("centerX", n.AQ)),
                ...
                if (s.isNumber(e) && s.isNumber(t)) {
                  ...
                  for (; h < o; ) {
                    ...
                    this.dataItems.length < c + 1
                      ? ((d = new r.z(this, void 0, {})),
                        this._dataItems.push(d),
                        this.processDataItem(d))
                      : (d = this.dataItems[c]),
                      this._createAssets(d, []),
                      d.isHidden() && d.show(),
                      d.setRaw("value", h);
                    var g = d.get("label");
                    g && g.set("text", this._formatText(h)),
                      this._prepareDataItem(d),
                      i && p > 2
                    ...
                    if (f < 1) {
                      var m =
                        Math.round(
                          Math.abs(Math.log(Math.abs(f)) * Math.LOG10E)
                        ) + 2;
                      h = u.round(h, m);
                    }
                    c++;
                  }
                  for (var v = c; v < this.dataItems.length; v++)
                    this.dataItems[v].hide();
                  l.each(this.series, function (e) {
                    e.inited && e._markDirtyAxes();
                  }),
                    this._updateGhost();
                  ...
                  if (
                    (w &&
                      ((x = this._syncAxes(
                        ...
                        r,
                        x.step,
                        w.getPrivate("minFinal", w.getPrivate("min", 0)),
                        w.getPrivate("maxFinal", w.getPrivate("max", 1)),
                        w.getPrivate("step", 1)
                      )),
                      (a = x.min),
                      (r = x.max)),
              ...
              value: function (e, t) {
                ...
                if (null != l && null != u) {
                  var h,
                    ...
                    d = this._xOpenField,
                    g = this._yOpenField,
                    f = this.get("locationX", e.get("locationX", 0.5)),
                    m = this.get("locationY", e.get("locationY", 0.5)),
                  ...
                  if (O.isType("CategoryAxis") && P.isType("CategoryAxis")) {
                    var S = this._aLocationX0 + v - 0.5,
                      X = this._aLocationX1 + f - 0.5;
                    _ instanceof n.gG &&
                      ((S += N = ((X - S) * (1 - _.value)) / 2), (X -= N)),
                      (h = P.getDataItemPositionX(e, d, S, M)),
                      (c = P.getDataItemPositionX(e, r, X, M)),
                      (S = this._aLocationY0 + y - 0.5),
                      (X = this._aLocationY1 + m - 0.5),
                      x instanceof n.gG &&
                        ((S += N = ((X - S) * (1 - x.value)) / 2), (X -= N)),
                      (p = O.getDataItemPositionY(e, g, S, I)),
                      (b = O.getDataItemPositionY(e, o, X, I)),
                      e.setRaw("point", {
                        x: h + (c - h) / 2,
                        y: p + (b - p) / 2,
                      });
                    ...
                    if (
                      ((S = this._aLocationX0 + v - 0.5),
                      (X = this._aLocationX1 + f - 0.5),
                      _ instanceof n.gG &&
                        ((S += N = ((X - S) * (1 - _.value)) / 2), (X -= N)),
                      (h = P.getDataItemPositionX(e, d, S, M)),
                      (c = P.getDataItemPositionX(e, r, X, M)),
                      (p = O.getDataItemPositionY(e, o, m, I)),
                      this._yOpenField !== this._yField)
                    )
                      b = O.getDataItemPositionY(e, g, y, I);
                    else if (w) {
                      var F = e.get("stackToItemY");
                      b = F
                        ? O.getDataItemPositionY(
                            F,
                            o,
                            y,
                            F.component.get("vcy")
                    ...
                    if (
                      ...
                      (p = O.getDataItemPositionY(e, g, S, I)),
                      (b = O.getDataItemPositionY(e, o, X, I)),
                      (c = P.getDataItemPositionX(e, r, f, M)),
                      this._xOpenField !== this._xField)
                    )
                      h = P.getDataItemPositionX(e, d, v, M);
                    else if (w) {
                  ...
                  this._updateSeriesGraphics(e, a, h, c, p, b, C, Y),
                    (h < j && c < j) ||
                    (h > D && c > D) ||
                    (p < A && b < A) ||
                    (p > k && b > k)
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_updateChildren", {
              ...
              value: function () {
                ...
                if (this.isDirty("curveFactory")) {
                  ...
                  u &&
                    (this._strokeGenerator.curve(u),
                    this._fillGenerator.curve(u));
                }
                if (t.inited && i.inited) {
                  if (
                    this._axesDirty ||
                    ...
                    for (
                      var g = function (e) {
                          ...
                          if (
                            (c && a[c] && (b = !0),
                            p && a[p] && (d = !0),
                            s.each(f._valueFields, function (e) {
                    ...
                    if (y < v) {
                      ...
                      var _ = function (e) {
                          var t = x.dataItems[e],
                            i = !0;
                          if (
                            (s.each(x._valueFields, function (e) {
                              o.isNumber(t.get(e)) || (i = !1);
                            }),
                            i)
                          )
            ...
            Object.defineProperty(t.prototype, "_startSegment", {
              ...
              value: function (e, t) {
                ...
                p && p != this.strokes.template && (c.template = p),
                  c.setPrivate("visible", !0);
                ...
                var I,
                  ...
                  Y = this.get("locationX", 0.5),
                  S = this.get("locationY", 0.5),
                ...
                for (I = t; I < r; I++) {
                  ...
                  if (
                    ...
                    if (U) {
                      if (
                        (U instanceof h.YS || (U = h.YS.new(U)),
                  ...
                  if (C) {
                    ...
                    if (z) {
                      if (
                        (z instanceof h.YS || (z = h.YS.new(z)),
                  ...
                  if (!o) {
                    ...
                    W &&
                      g.shouldGap(V, W, n, O) &&
                      ((k = []), A.push(k), (L.points = k));
                  }
                }
                s.setRaw("userData", [t, I]),
                  c.setRaw("userData", [t, I]),
                  I === a && this._endLine(k, A[0][0]),
                  c && this._drawStroke(c, A),
                  s && this._drawFill(s, A),
                  this.axisRanges.each(function (e) {
                    var a = e.container,
                      r = e.fills,
                      n = i.makeFill(r);
                ...
                if (this._shouldInclude(n)) {
                  ...
                  if (
                    ...
                    if (
                      (t.baseAxis === t.xAxis
                        ? (c = t.basePosY)
                        : t.baseAxis === t.yAxis && (h = t.basePosX),
                      t.getOpen)
                    ) {
                      ...
                      if (null != p && null != b) {
                        ...
                        if (t.stacked) {
                          ...
                          f
                            ? ((h = t.xAxis.getDataItemPositionX(
                                f,
                                t.xField,
                                d,
                                f.component.get("vcx")
                              )),
                              o.isNaN(h) && (h = t.basePosX))
                            : (h =
                                t.yAxis === t.baseAxis
                                  ? t.basePosX
                            ...
                            m
                              ? ((c = t.yAxis.getDataItemPositionY(
                                  m,
                                  t.yField,
                                  g,
                                  m.component.get("vcy")
                                )),
                                o.isNaN(c) && (c = t.basePosY))
                              : (c =
                                  t.xAxis === t.baseAxis
                                    ? t.basePosY
            ...
            Object.defineProperty(t.prototype, "_processAxisRange", {
              ...
              value: function (t) {
                var i = this;
                e.prototype._processAxisRange.call(this, t),
                  (t.fills = new c.o(h.YS.new({}), function () {
                    return n.T._new(
                      i._root,
                      {
                        themeTags: g.mergeTags(
              ...
              value: function (e) {
                ...
                if (t) {
                  ...
                  a && a.setPrivate("visible", !1),
                    i.set(
                      "background",
                      d.A.new(i._root, { fillOpacity: 0, fill: (0, p.$_)(0) })
                    );
                  ...
                  if (
                    ...
                    if (l) {
                      ...
                      if (u) {
                        var h = u.get("sprite");
                        h instanceof n.T &&
                          h.states.create("disabled", { fill: s, stroke: s }),
                          h &&
                            (h.set("tooltipText", void 0),
                            i.children.push(h),
                            h.setAll({ x: i.width() / 2, y: i.height() / 2 }));
                      }
                    }
                  }
                }
                ...
                if (t) {
                  ...
                  if (this._shouldShowBullet(s, l)) {
                    ...
                    var d = c - h,
                      g = b - p;
                    t.isType("Label") &&
                      (t.set("maxWidth", Math.abs(d)),
                      t.set("maxHeight", Math.abs(g)));
                    var f = h + d * a,
                      m = b - g * r;
                    t.set("x", f), t.set("y", m);
        ...
        h = (function (e) {
          function t() {
            ...
            return (
              ...
              Object.defineProperty(t, "overlay", {
                ...
                writable: !0,
                value: t.children.push(
                  l.T.new(t._root, { themeTags: ["overlay"], interactive: !1 })
                ),
              }),
              t
            );
          ...
          return (
                ...
                e.prototype._updateThumb.call(this),
                  this.overlay.set("draw", function (e) {
                    var i,
                      ...
                      c = t.height(),
                      p = t.width();
                    s > u && ((s = (i = (0, o.CR)([u, s], 2))[0]), (u = i[1])),
                      l > h &&
                        ((l = (a = (0, o.CR)([h, l], 2))[0]), (h = a[1])),
            ...
            Object.defineProperty(t, "classNames", {
              ...
              configurable: !0,
              writable: !0,
              value: s.L.classNames.concat([t.className]),
            }),
            t
          );
        })(s.L),
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_prepareChildren", {
              ...
              value: function () {
                ...
                var i = this.dataItems.length,
                  a = 0;
                this._valuesDirty &&
                  (d.each(this.dataItems, function (e) {
                    e.setRaw("index", a),
                ...
                d.each(this.series, function (i) {
                  ...
                  if (o instanceof t && s instanceof t) i._markDirtyAxes();
                    ...
                    if (
                      ...
                      c && i.setPrivate("startIndex", i.dataItems.indexOf(c)),
                        p &&
                          i.setPrivate("endIndex", i.dataItems.indexOf(p) + 1);
                    }
                    i._markDirtyAxes();
                  }
                });
            ...
            Object.defineProperty(t.prototype, "_prepareDataItem", {
              ...
              value: function (e, t, i) {
                var a = this.get("renderer"),
                  ...
                  o = e.get("index");
                g.isNumber(o) || (o = this.categoryToIndex(e.get("category")));
                var s,
                  l = this.indexToPosition(o, r),
                  u = e.get("endCategory");
                u
                  ? ((s = this.categoryToIndex(u)), g.isNumber(s) || (s = o))
                  : (s = o);
                var h,
                  c,
            ...
            Object.defineProperty(t.prototype, "axisPositionToIndex", {
              ...
              value: function (e) {
                ...
                return f.fitToRange(Math.floor(e * t), 0, t - 1);
              },
            }),
            Object.defineProperty(t.prototype, "getTooltipText", {
              enumerable: !1,
              ...
              value: function (e) {
                ...
                if (t) {
                  var i = t.get("label");
                  if (i) return (0, m.q)(i, this.get("tooltipText", ""));
                }
              },
            }),
            Object.defineProperty(t.prototype, "_updateTooltipText", {
            ...
            Object.defineProperty(t, "classNames", {
              ...
              configurable: !0,
              writable: !0,
              value: b.R.classNames.concat([t.className]),
            }),
            t
          );
        })(b.R),
        ...
        _ = (function (e) {
          ...
          return (
              ...
              value: function () {
                ...
                r - a < n &&
                  (c =
                    h -
                    u -
                    ((h - u) / this.baseDuration() - (r - a)) *
                      this.baseDuration());
                var p = y.chooseInterval(0, c, n, this.get("gridIntervals")),
                  b = y.getNextUnit(p.timeUnit),
                  f = this.getPrivate("baseInterval");
                y.getIntervalDuration(p) < this.baseDuration() &&
                  (p = (0, o.pi)({}, f));
                for (
                  var m,
                    v = this.get("dateFormats"),
                    _ = -1 / 0,
                    x = -1 / 0,
                    w = -1 / 0,
                    P = [],
                  ...
                  "year" != p.timeUnit &&
                    ...
                    this.get("markUnitChange") &&
                    g.isNumber(_) &&
                    y.checkChange(k, _, b, this._root.utc) &&
                    ((m = this.get("periodChangeDateFormats")[p.timeUnit]),
                    D - 0.5 * s < x && P.pop(),
                    P.push({ format: m, dataItem: j }),
                    (O = !0),
                    (C = !0),
                    (x = D),
                    (w = M));
                  var Y = !1;
                  "day" === p.timeUnit || "week" === p.timeUnit
                    ? D - x >= s && (Y = !0)
                    : M % p.count == 0 && M != w && (Y = !0),
                    !C &&
                      Y &&
                      (D - 0.7 * s < x && O && (A = !0),
                      A ||
                        (P.push({ format: m, dataItem: j }), (x = D), (w = M)),
                      (O = !1)),
                    (_ = k);
                }
                if (P.length > 0) {
            ...
            Object.defineProperty(t.prototype, "baseDuration", {
              ...
              writable: !0,
              value: function () {
                return y.getIntervalDuration(this.getPrivate("baseInterval"));
              },
            }),
            Object.defineProperty(t.prototype, "getTooltipText", {
              enumerable: !1,
        ...
        O = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "getTooltipText", {
              ...
              value: function (e) {
                var t = this.getDurationFormatter(),
                  ...
                  r = f.round(this.positionToValue(e), a);
                return t.format(
                  r,
                  this.getPrivate("durationFormat"),
                  this.get("baseUnit")
            ...
            Object.defineProperty(t, "classNames", {
              ...
              configurable: !0,
              writable: !0,
              value: P.m.classNames.concat([t.className]),
            }),
            t
          );
        })(P.m),
        ...
        j = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t, "classNames", {
              ...
              configurable: !0,
              writable: !0,
              value: T.JH.classNames.concat([t.className]),
            }),
            t
          );
        })(T.JH),
        ...
        N = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t, "classNames", {
              ...
              configurable: !0,
              writable: !0,
              value: X.j.classNames.concat([t.className]),
            }),
            t
          );
        })(X.j),
          ...
          function t() {
            ...
            return (
              Object.defineProperty(t, "columns", {
                ...
                writable: !0,
                value: new L.o(
                  R.YS.new({ themeTags: ["autocolor"] }),
                  function () {
                    return N._new(
                      t._root,
                      {
                        themeTags: u.mergeTags(
                          t.columns.template.get("themeTags", []),
                          ["ohlc", "series", "column"]
                        ),
                      },
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_processAxisRange", {
              ...
              value: function (t) {
                var i = this;
                e.prototype._processAxisRange.call(this, t),
                  (t.columns = new L.o(R.YS.new({}), function () {
                    return N._new(
                      i._root,
                      {
                        themeTags: u.mergeTags(
        ...
        z = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_updateChildren", {
              ...
              value: function () {
                this.isDirty("tension") &&
                  (this.set("curveFactory", (0, U.$)(this.get("tension", 0.5))),
                  (this._valuesDirty = !0)),
                  e.prototype._updateChildren.call(this);
              },
            }),
            ...
            Object.defineProperty(t, "classNames", {
              ...
              configurable: !0,
              writable: !0,
              value: E.e.classNames.concat([t.className]),
            }),
            t
          );
        })(E.e),
        ...
        B = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_updateChildren", {
              ...
              value: function () {
                this.isDirty("tension") &&
                  (this.set("curveFactory", (0, W.G)(this.get("tension", 0.5))),
                  (this._valuesDirty = !0)),
                  e.prototype._updateChildren.call(this);
              },
            }),
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_afterNew", {
              ...
              value: function () {
                this._setDefault(
                  "curveFactory",
                  Z.ZP.tension(this.get("tension", 0.5))
                ),
                  e.prototype._afterNew.call(this);
              },
            }),
      ...
      var q = (function (e) {
          ...
          return (
            ...
            Object.defineProperty(t.prototype, "_afterNew", {
              ...
              writable: !0,
              value: function () {
                this._setDefault("curveFactory", r),
                  e.prototype._afterNew.call(this);
              },
            }),
            Object.defineProperty(t.prototype, "_getPoints", {
              ...
              value: function (e, t) {
                var i = t.points,
                  a = this.get("stepWidth", Q.AQ).value / 2,
