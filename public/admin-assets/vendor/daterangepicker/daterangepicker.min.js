...
!(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    if (
      ...
      "string" ==
        typeof (options = $.extend(this.element.data(), options)).template ||
      ...
      "object" == typeof options.locale &&
        ("string" == typeof options.locale.direction &&
      ...
      (elem = document.createElement("textarea")).innerHTML =
    ...
    if (
      ...
      "string" == typeof options.applyButtonClasses &&
        (this.applyButtonClasses = options.applyButtonClasses),
      "string" == typeof options.applyClass &&
        (this.applyButtonClasses = options.applyClass),
      "string" == typeof options.cancelButtonClasses &&
        (this.cancelButtonClasses = options.cancelButtonClasses),
      "string" == typeof options.cancelClass &&
        (this.cancelButtonClasses = options.cancelClass),
      "object" == typeof options.maxSpan && (this.maxSpan = options.maxSpan),
      ...
      "boolean" == typeof options.showISOWeekNumbers &&
      ...
      "number" == typeof options.minYear && (this.minYear = options.minYear),
      "number" == typeof options.maxYear && (this.maxYear = options.maxYear),
      "boolean" == typeof options.showCustomRangeLabel &&
      ...
      "function" == typeof options.isCustomDate &&
        (this.isCustomDate = options.isCustomDate),
      "boolean" == typeof options.alwaysShowCalendars &&
    ...
    "function" == typeof cb && (this.callback = cb),
      ...
      ((void 0 === options.ranges && !this.singleDatePicker) ||
  ...
  return (
    (DateRangePicker.prototype = {
      ...
      updateCalendars: function () {
        if (this.timePicker) {
          ...
          if (this.endDate) {
            ...
            "PM" === (ampm = this.container.find(".right .ampmselect").val()) &&
              hour < 12 &&
              (hour += 12),
              "AM" === ampm && 12 === hour && (hour = 0);
      ...
      renderCalendar: function (side) {
        ...
        startDay > daysInLastMonth && (startDay -= 7),
          dayOfWeek == this.locale.firstDay && (startDay = daysInLastMonth - 6);
        for (
          var curDate = moment([
              lastYear,
              lastMonth,
        ...
        if (this.showDropdowns) {
          for (
            var currentMonth = calendar[1][1].month(),
              ...
              maxYear = (maxDate && maxDate.year()) || this.maxYear,
              minYear = (minDate && minDate.year()) || this.minYear,
          ...
          if (
            ...
            if (
              ...
              "PM" === ampm &&
                ...
                "AM" === ampm && 12 === selected.hour() && selected.hour(0);
            }
            selected.isBefore(this.startDate) &&
              (selected = this.startDate.clone()),
              maxDate &&
                selected.isAfter(maxDate) &&
      ...
      move: function () {
        ...
        if (
          ...
          containerWidth + containerRight > $(window).width()
          ...
          (containerLeft =
            ...
            containerWidth / 2) < 0
            ? this.container.css({ top: containerTop, right: "auto", left: 9 })
            : containerLeft + containerWidth > $(window).width()
      ...
      clickRange: function (e) {
        ...
        if (((this.chosenLabel = label), label == this.locale.customRangeLabel))
          this.showCalendars();
        else {
      ...
      clickPrev: function (e) {
        $(e.target).parents(".drp-calendar").hasClass("left")
      ...
      hoverDate: function (e) {
        if ($(e.target).hasClass("available")) {
          var title = $(e.target).attr("data-title"),
            ...
            date = $(e.target).parents(".drp-calendar").hasClass("left")
              ...
              .each(function (index, el) {
                if (!$(el).hasClass("week")) {
                  var title = $(el).attr("data-title"),
                    row = title.substr(1, 1),
                    col = title.substr(3, 1),
                    dt = $(el).parents(".drp-calendar").hasClass("left")
    ...
    ($.fn.daterangepicker = function (options, callback) {
      ...
      return (
        this.each(function () {
          var el = $(this);
          el.data("daterangepicker") && el.data("daterangepicker").remove(),
            el.data(
              "daterangepicker",
