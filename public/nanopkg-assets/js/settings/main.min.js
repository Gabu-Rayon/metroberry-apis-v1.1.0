...
$(function () {
  $(".message-content").on("click", function () {
    ...
    $("#extraOptionDocOpen").on("click", function () {
      $("#extraOptionDetails").css({ display: "block" }),
        $(this).css({ display: "none" }),
        $("#extraOptionDocClose").css({ display: "inline-block" });
    }),
    $("#extraOptionDocClose").on("click", function () {
      $("#extraOptionDetails").css({ display: "none" }),
        $(this).css({ display: "none" }),
        $("#extraOptionDocOpen").css({ display: "inline-block" });
    }),
    $("#extraOptionOpen").on("click", function () {
      $("#extraOption").css({ display: "block" }),
        $(this).css({ display: "none" }),
        $("#extraOptionClose").css({ display: "inline-block" });
    }),
    $("#extraOptionClose").on("click", function () {
      $("#extraOption").css({ display: "none" }),
        $(this).css({ display: "none" }),
        $("#extraOptionOpen").css({ display: "inline-block" }),
        $("#setting_details_textarea").val("");
    }),
    $("#addNoteOpen").on("click", function () {
      $("#addNote").css({ display: "block" }),
        $(this).css({ display: "none" }),
        $("#addNoteClose").css({ display: "inline-block" });
    }),
    $("#addNoteClose").on("click", function () {
      $("#addNote").css({ display: "none" }),
        $(this).css({ display: "none" }),
        $("#addNoteOpen").css({ display: "inline-block" }),
    ...
    e[t].getAttribute("data-theme") &&
      ...
      n.on("change", function (e, t) {
        ...
        if (
          ...
          data_language && "json" == data_language)
        )
          try {
