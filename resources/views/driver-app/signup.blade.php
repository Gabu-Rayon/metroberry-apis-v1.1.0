...
@section('title', 'Register Account | Driver')
@section('content')
        ...
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="rest-container">
                ...
                <div class="sign-up-form-container text-center">
                    ...
                    <form class="width-100"method="POST" action="{{ route('driver.signup') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input class="form-control" id="phone-input" type="text" name="phone" autocomplete="on"
                                    data-intl-tel-input-id="0" placeholder="(254) 70 0000 000" value="{{ old('phone') }}">
                            </div>
                        </div>
                    ...
                    <div class="text-center sms-rate-text">
                        <a href="{{ route('users.sign.in.page') }}" class="regular-link">Already have an account ? Sign
                            in</a>
                    </div>
                </div>
            </div>
