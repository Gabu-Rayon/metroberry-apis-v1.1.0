                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        ...
                        @if ($customer->national_id_front_avatar)
                            <div class="mt-2">
                                <a href="{{ asset('uploads/front-page-ids/' .basename($customer->national_id_front_avatar)) }}" download>Download
                                    Front Page ID</a>
                            </div>
                        @endif
                    </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="avatar" class="form-control" type="file" placeholder="Avatar" id="avatar"
                            value="" />
                        <img src="{{ asset('uploads/user-avatars/' .basename($customer->user->avatar)) }}" alt="Avatar"
                            class="form-control" />
                    </div>
                </div>
