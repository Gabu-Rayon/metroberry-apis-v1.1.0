                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $licenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $license): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($license->first_date_of_issue); ?></td>
                                                            <td><?php echo e($license->driving_license_renewal_date_issue); ?></td>
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input name="driving_license_renewal_date_issue" class="form-control" type="date"
                                            ...
                                            value="<?php echo e(old('driving_license_renewal_date_issue')); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input name="first_date_of_issue" class="form-control" type="date"
                                            ...
                                            value="<?php echo e(old('first_date_of_issue')); ?>" />
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/driver/license/index.blade.php ENDPATH**/ ?>