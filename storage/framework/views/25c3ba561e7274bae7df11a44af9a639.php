...
unset($__errorArgs, $__bag); ?>" id="avatar" name="avatar">
                                                <?php if(Auth::user()->avatar): ?>
                                                    <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" alt="Profile Image" class="img-thumbnail mt-2" style="max-height: 150px;">
                                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" id="address" name="address" value="<?php echo e(old('address', Auth::user()->address)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/profile/edit.blade.php ENDPATH**/ ?>