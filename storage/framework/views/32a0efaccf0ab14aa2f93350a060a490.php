<?php $__env->startSection('title', 'Maintenance Setting'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-4 p-5">
                                            <form action="<?php echo e(route('settings.maintenance.update')); ?>" method="POST"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input id="maintenance_code_prefix" class="form-control"
                                                                        ...
                                                                        value="<?php echo e(old('maintenance_code_prefix', $maintenance_code_prefix)); ?>" />
                                                                    <div class="my-1">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <input id="maintenance_requisition_prefix"
                                                                        ...
                                                                        value="<?php echo e(old('maintenance_requisition_prefix', $maintenance_requisition_prefix)); ?>" />
                                                                    <div class="my-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/settings/general-settings/maintenance-setting.blade.php ENDPATH**/ ?>