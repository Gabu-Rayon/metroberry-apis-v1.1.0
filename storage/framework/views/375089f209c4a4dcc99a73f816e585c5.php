                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        ...
                        <?php if($psvbadge->psv_badge_avatar): ?>
                            <div class="mt-2">
                                <a href="<?php echo e(asset($psvbadge->psv_badge_avatar)); ?>" download>Download Badge Copy</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/driver/psvbadge/edit.blade.php ENDPATH**/ ?>