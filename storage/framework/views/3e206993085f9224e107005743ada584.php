<?php $__env->startSection('title', 'Fuel Stations'); ?>
    ...
    <body class="fixed sidebar-mini">
                                                ...
                                                <table class="table" id="driver-table">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $station): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><?php echo e($station->user->name); ?></td>
                                                                <td><?php echo e($station->user->email); ?></td>
                                                                <td><?php echo e($station->user->phone); ?></td>
                                                                <td><?php echo e($station->user->address); ?></td>
                                                                <td class="text-center">
                                                                    ...
                                                                    ?>
                                                                    <span
                                                                        class="<?php echo e($badgeClass); ?>"><?php echo e($badgeText); ?></span>
                                                                </td>
                                                                <td class="text-center">
                                                                    <a href="javascript:void(0);"
                                                                        onclick="axiosModal('<?php echo e(route('refueling.station.edit', $station->id)); ?>')"
                                                                    ...
                                                                    <?php if($station->status == 'active'): ?>
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            onclick="axiosModal('<?php echo e(route('refueling.station.deactivate', $station->id)); ?>')"
                                                                    ...
                                                                    <?php else: ?>
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            onclick="axiosModal('<?php echo e(route('refueling.station.activate', $station->id)); ?>')"
                                                                            title="Activate Station">
                                                                            <i class="fas fa-toggle-off"></i>
                                                                        </a>
                                                                    <?php endif; ?>
                                                                    <a href="javascript:void(0);"
                                                                        onclick="axiosModal('<?php echo e(route('refueling.station.delete', $station->id)); ?>')"
        ...
        <div class="modal fade" id="refuellingStationModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <form action="<?php echo e(route('refueling.station.create')); ?>" method="POST"
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input name="station_code" class="form-control" type="text"
                                            ...
                                            value="<?php echo e(old('station_code')); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input name="certificate_of_operations" class="form-control" type="file"
                                            ...
                                            required value="<?php echo e(old('certificate_of_operations')); ?>" />
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/refueling/station/index.blade.php ENDPATH**/ ?>