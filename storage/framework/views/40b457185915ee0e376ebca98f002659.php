                                            ...
                                            <div class="text-end">
                                                <div class="actions">
                                                    <div class="accordion-header d-flex justify-content-end align-items-center"
                                                        id="flush-headingOne">
                                                        <?php if(\Auth::user()->can('export driver')): ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <span class='m-1'></span>
                                                        <?php if(\Auth::user()->can('import driver')): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/app/resources/views/driver/index.blade.php ENDPATH**/ ?>