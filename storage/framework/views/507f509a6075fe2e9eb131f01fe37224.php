                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        ...
                        <?php if($customer->national_id_front_avatar): ?>
                            <div class="mt-2">
                                <a href="<?php echo e(url('storage/' . $customer->national_id_front_avatar)); ?>" download>Download
                                    Front Page ID</a>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="avatar" class="form-control" type="file" placeholder="Avatar" id="avatar"
                            value="" />
                        <img src="<?php echo e(url('storage/' . $customer->user->avatar)); ?>" alt="Avatar"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        ...
                        <?php if($customer->national_id_behind_avatar): ?>
                            <div class="mt-2">
                                <a href="<?php echo e(url('storage/' . $customer->national_id_behind_avatar)); ?>"
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/app/resources/views/employee/edit.blade.php ENDPATH**/ ?>