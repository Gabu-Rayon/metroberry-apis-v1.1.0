                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="station"
                                            value="<?php echo e($station->user->name); ?>" readonly>
                                        <input type="hidden" name="station" value="<?php echo e($station->id); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/refueling/index.blade.php ENDPATH**/ ?>