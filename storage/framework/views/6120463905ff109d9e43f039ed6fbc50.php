<?php $__env->startSection('title', 'Vehicle Part Categories'); ?>
    ...
    <body class="fixed sidebar-mini">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0);"
                                                                    onclick="axiosModal('<?php echo e(route('vehicle.maintenance.parts.category.edit', $category->id)); ?>')"
                                                                    class="btn btn-primary btn-sm">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a href="javascript:void(0);"
                                                                    onclick="axiosModal('<?php echo e(route('vehicle.maintenance.parts.category.delete', $category->id)); ?>')"
        ...
        <div class="modal fade" id="vehiclePartCategoryModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <form action="<?php echo e(route('vehicle.maintenance.parts.category.create')); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/vehicle/maintenance/parts/category/index.blade.php ENDPATH**/ ?>