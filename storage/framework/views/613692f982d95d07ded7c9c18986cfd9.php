<?php $__env->startSection('title', 'Route Locations'); ?>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <div class="actions">
                                                <?php if(Auth::user()->can('export route locations')): ?>
                                                    <a class="btn btn-success btn-sm"
                                                        href=<?php echo e(route('route.location.export')); ?> title="Export">
                                                        <i class="fa-solid fa-file-export"></i>&nbsp;
                                                        Export
                                                    </a>
                                                <?php endif; ?>
                                                <span class='m-1'></span>
                                                <?php if(Auth::user()->can('import route locations')): ?>
                                                    <a class="btn btn-success btn-sm"
                                                        href="<?php echo e(route('route.location.import')); ?>"
                                                ...
                                                <?php endif; ?>
                                                <span class="m-1"></span>
                                                <?php if(Auth::user()->can('create route location')): ?>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table" id="driver-table">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $routelocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $routelocation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($routelocation->route->name); ?></td>
                                                        <td><?php echo e($routelocation->name); ?></td>
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                            <span><?php echo e($point_order); ?></span>
                                                        </td>
                                                        <?php if(Auth::user()->role = 'admin'): ?>
                                                            <td class="d-flex">
                                                                <a href="javascript:void(0);" class="btn btn-sm btn-primary"
                                                                    onclick="axiosModal('location/<?php echo e($routelocation->id); ?>/edit')">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <span class='m-1'></span>
                                                                <a href="javascript:void(0);" class="btn btn-sm btn-danger"
                                                                    onclick="axiosModal('location/<?php echo e($routelocation->id); ?>/delete')">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-sm-7">
                                        <input name="point_order" class="form-control" type="number"
                                            ...
                                            value="<?php echo e(old('point_order')); ?>" />
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/route/locations/index.blade.php ENDPATH**/ ?>