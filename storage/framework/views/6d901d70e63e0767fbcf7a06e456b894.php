                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="first_date_of_issue" required class="form-control" type="date"
                            ...
                            value="<?php echo e($license->first_date_of_issue); ?>" />
                    </div>
                </div>
                 <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="driving_license_renewal_date_issue" required class="form-control" type="date"
                            ...
                            value="<?php echo e($license->driving_license_renewal_date_issue); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        ...
                        <?php if($license->driving_license_avatar_front): ?>
                            <div class="mt-2">
                                <a href="<?php echo e(asset($license->driving_license_avatar_front)); ?>"
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        ...
                        <?php if($license->driving_license_avatar_back): ?>
                            <div class="mt-2">
                                <a href="<?php echo e(asset($license->driving_license_avatar_back)); ?>"
