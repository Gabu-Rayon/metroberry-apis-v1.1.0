                ...
                <div class="sign-up-form-container">
                    <div class="width-100">
                        ...
                        <div class="border-bottom-primary">
                            <a href="<?php echo e(route('trips.assigned.page')); ?>" class="home-options-list href-decoration-none">
                                Assgined Trips
                        ...
                        <!--Driver Assigned Item Start-->
                        <div class="border-bottom-primary">
                            <a href="<?php echo e(route('trips.completed.page')); ?>" class="home-options-list href-decoration-none">
                                Completed
                                <span class="fas fa-check icon chosen hidden"></span>
                                <span class="icon choose float-right">
                                    <img src="<?php echo e(asset('mobile-app-assets/icons/angle-right.svg')); ?>"
...
<?php echo $__env->make('layouts.mobile-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/driver-app/trips-history.blade.php ENDPATH**/ ?>