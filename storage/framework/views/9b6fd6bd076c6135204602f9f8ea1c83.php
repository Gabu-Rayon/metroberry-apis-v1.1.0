<?php $__env->startSection('title', 'Trips Completed | Driver'); ?>
            ...
            <div class="rest-container">
                <div class="all-history-items remaining-height">
                    <div class="change-request-status">
                        ...
                        <?php else: ?>
                            <?php if(!$driver->driverLicense?->verified && !$driver->psvBadge?->verified): ?>
                                <div
                                    class="request-notification-container map-notification offline-notification map-notification-warning">
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <div
                                        ...
                                        <form action="<?php echo e(route('driver.license')); ?>" method="POST"
                                ...
                                <?php else: ?>
                                    <div
                                        ...
                                        <form action="<?php echo e(route('driver.psvbadge')); ?>" method="POST"
                                            enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            <div class="mb-3">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="map-input display-flex">
                                                                        <input class="controls flex-1 font-weight-light"
                                                                            ...
                                                                            value="<?php echo e($trip->drop_off_location); ?>"
                                                                            disabled>
                                                                    </div>
                                                                </div>
                                                                <a href="#"
...
<?php echo $__env->make('layouts.mobile-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/driver-app/trips-completed.blade.php ENDPATH**/ ?>