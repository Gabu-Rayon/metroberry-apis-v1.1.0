...
<body>
    ...
    <div class=" w-100 h-100">
        ...
        <div class="d-flex h-100 justify-content-center align-items-center flex-column">
            <a href="<?php echo e(route('sign.up.options.page')); ?>" class="loading-logo-margin"><img
                    src="<?php echo e(asset('mobile-app-assets/images/logo-metro.png')); ?>" height="150" width="300"
                    alt="Main Logo"></a>
            <div>
...
<?php /**PATH /home/chris-droid/Desktop/metro/metroberry-apis-v1.1.0/resources/views/welcome.blade.php ENDPATH**/ ?>