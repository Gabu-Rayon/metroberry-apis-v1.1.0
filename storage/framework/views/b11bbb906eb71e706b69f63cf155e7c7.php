    ...
    <div class="col-xs-12 col-sm-12">
        ...
        <div class="rest-container">
            <div class="address-title">Driver's License
                ...
                <?php if($driver->driverLicense->verified != 0): ?>
                ...
                <form class="width-100" action="<?php echo e(route('driver.license.document.update', $driver->id)); ?>"
                    ...
                    <div class="form-group form-control-margin">
                        ...
                        <div class="input-group">
                            <input class="form-control form-control-with-padding" type="text" name="driving_license_no"
                                autocomplete="off" placeholder="Driver License Number"
                                value="<?php echo e($driver->driverLicense->driving_license_no ?? null); ?>" />
                    ...
                    <div class="form-group form-control-margin">
                        <label class="label-title">First Date of issue : <span class="text-primary">
                                <?php echo e($driver->driverLicense->first_date_of_issue ?? null); ?></span></label>
                        <div class="input-group">
                            <input class="form-control form-control-with-padding" type="date" name="first_date_of_issue"
                                autocomplete="off" placeholder="Driver First Date of Issue" value="#" />
                        </div>
                    </div>
                    <!--Input Field Container End-->
                    ...
                    <div class="form-group form-control-margin">
                        <label class="label-title">Renewal Date : <span class="text-primary">
                                <?php echo e($driver->driverLicense->driving_license_renewal_date_issue ?? null); ?></span></label>
                        <div class="input-group">
                    ...
                    <div class="form-group form-control-margin">
                        <label class="label-title">Expiry Date : <span
                                class="text-primary"><?php echo e($driver->driverLicense->driving_license_date_of_expiry ?? null); ?></span>
                        </label>
                        <div class="input-group">
                            <input class="form-control form-control-with-padding" type="date"
                            ...
                            <div class="display-flex justify-content-between">
                                <span class="position-relative upload-btn">
                                    <img src="<?php echo e(asset('mobile-app-assets/icons/upload.svg')); ?>"
                                        alt="Upload Icon" />
                                    <input class="scan-prompt" type="file" accept="image/*" name="license_front_avatar"
                                        id="national-id-front-input" />
                                </span>
                                    ...
                                    <div class="upload-picture-container">
                                        <div class="upload-camera-container text-center">
                                            <span class="#">
                                                ...
                                                <img id="national-id-front-preview" src="<?php echo e($driver->driverLicense && $driver->driverLicense->driving_license_avatar_front
                        ...
                        <label class="width-100">
                            <div class="display-flex justify-content-between">
                                <span class="position-relative upload-btn">
                                    <img src="<?php echo e(asset('mobile-app-assets/icons/upload.svg')); ?>"
                                        alt="Upload Icon" />
                                    <input class="scan-prompt" type="file" accept="image/*" name="license_back_avatar"
                                        id="national-id-back-input" />
                                </span>
                                    ...
                                    <div class="upload-picture-container">
                                        <div class="upload-camera-container text-center">
                                            <span class="#">
                                                ...
                                                <img id="national-id-back-preview" src="<?php echo e($driver->driverLicense && $driver->driverLicense->driving_license_avatar_back
