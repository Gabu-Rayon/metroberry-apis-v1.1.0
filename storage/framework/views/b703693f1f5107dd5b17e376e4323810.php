    ...
    <div class="col-xs-12 col-sm-12">
        ...
        <div class="rest-container">
            <div class="address-title">Psv Badge
                ...
                <?php if($driver->psvBadge->verified != 0): ?>
            ...
            <div class="all-container all-container-with-classes">
                ...
                <?php endif; ?>
                <form class="width-100" action="<?php echo e(route('psvbadge.document.update', $driver->id)); ?>"
                                ...
                                <div class="position-relative">
                                    <div class="upload-picture-container">
                                        <div class="upload-camera-container text-center">
                                            <span class="#">
                                                <img id="national-id-back-preview" src="<?php echo e($driver->psvBadge && $driver->psvBadge->psv_badge_avatar
