...
<body>
    <div class="left-side">
        <img src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('logo.png')))); ?>" alt="Logo" />
    ...
    <div class="right-side">
        <div class="title">
            ...
            <div class="details">
                <div>Invoice #</div>
                <div class="variable"><?php echo e($data['invoice_number']); ?></div>
            </div>

            <div class="details">
                <div>Date:</div>
                <div class="variable"><?php echo e($data['date']); ?></div>
            </div>
        </div>

        <div class="user-details">
            <div class="name"><?php echo e($data['customer']); ?></div>
            <div class="location"><?php echo e($data['address']); ?></div>
        </div>
                ...
                <?php $__currentLoopData = $data['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php echo e($item->billed_by == 'time' ? $info2 : ''); ?>

                        </td>
                        <td class="text-center">Kes. <?php echo e($item['total_price']); ?></td>
                    </tr>
        ...
        ?>
        <div class="total">Total: KES <?php echo e($total); ?></div>
...
<?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/invoices/trip-invoice-template-send.blade.php ENDPATH**/ ?>