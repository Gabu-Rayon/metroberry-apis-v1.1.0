<form action="<?php echo e($trip->id); ?>/bill" method="POST" class="needs-validation modal-content" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="vehicle_mileage" readonly class="form-control" type="number"
                            placeholder="Vehicle Mileage" id="vehicle_mileage" value="<?php echo e($trip->vehicle_mileage); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="engine_hours" readonly class="form-control" type="number"
                            placeholder="Engine Hours" id="engine_hours" value="<?php echo e($trip->engine_hours); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <select name="billing_rate_id" class="form-control" id="billing_rate_id">
                            <?php $__currentLoopData = $billingRates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($rate->id); ?>"
                                    <?php echo e($trip->billing_rate_id == $rate->id ? 'selected' : ''); ?>>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="fuel_consumed" readonly class="form-control" type="number"
                            placeholder="Fuel Consumed" id="fuel_consumed" value="<?php echo e($trip->fuel_consumed); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="idle_time" readonly class="form-control" type="number" placeholder="Idle Time"
                            id="idle_time" value="<?php echo e($trip->idle_time); ?>" />
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="rate_per_km" class="form-control" type="number" placeholder="Rate Per KM"
                            id="rate_per_km" value="<?php echo e(old('rate_per_km')); ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="rate_per_minute" class="form-control" type="number"
                            placeholder="Rate Per Minute" id="rate_per_minute" value="<?php echo e(old('rate_per_minute')); ?>"
                            readonly>
                    </div>
                </div>
                ...
                <div class="form-group row my-2">
                    ...
                    <div class="col-sm-7">
                        <input name="rate_by_car_class" class="form-control" type="number"
                            ...
                            value="<?php echo e(old('rate_by_car_class')); ?>" readonly>
                    </div>
                </div>
            ...
            if (billingRateId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var vehicleClass =
                            "<?php echo e($trip->vehicle->class); ?>"; // Replace with actual PHP blade syntax to fetch vehicle class
...
<?php /**PATH /home/kknuicdz/metroBerry/resources/views/trips/bill.blade.php ENDPATH**/ ?>