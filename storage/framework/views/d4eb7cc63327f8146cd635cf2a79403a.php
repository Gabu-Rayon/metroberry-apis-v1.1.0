            ...
            <?php $__currentLoopData = $vehicleInsurances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insurance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        <span class='m-1'></span>
                        <?php if($insurance->status != 1): ?>
                            <?php if(Auth::user()->can('activate vehicle insurance')): ?>
                                <a href="javascript:void(0);" class="btn btn-sm btn-secondary"
                                    onclick="axiosModal('<?php echo e(route('vehicle.insurance.verify', $insurance->id)); ?>')"
                                    title="Verify">
                                    <i class="fas fa-toggle-off"></i>
                                </a>
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if(Auth::user()->can('deactivate vehicle insurance')): ?>
                                <a href="javascript:void(0);" class="btn btn-sm btn-success"
                                    onclick="axiosModal('<?php echo e(route('vehicle.insurance.suspend', $insurance->id)); ?>')"
                                    title="Suspend">
...
<?php /**PATH C:\xampp\htdocs\metroberry-apis-v1.1.0\resources\views/components/vehicles/insurances/table.blade.php ENDPATH**/ ?>