<nav class="sidebar-nav">
    <ul class="metismenu text-capitalize">
        ...
        <?php if(\Auth::user()->can('view dashboard')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-item', [
        ...
        <?php if(\Auth::user()->can('manage users')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Users',
        ...
        <?php if(\Auth::user()->can('manage vehicles')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Vehicles',
        ...
        <?php if(\Auth::user()->can('manage routes')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Routes',
        ...
        <?php if(\Auth::user()->can('manage trips')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Trips',
        ...
        <?php if(\Auth::user()->can('manage insurance companies')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Insurance',
        ...
        <?php if(\Auth::user()->can('manage maintenance')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Maintenance',
        ...
        <?php if(\Auth::user()->can('manage fuelling')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Refueling',
        ...
        <?php if(\Auth::user()->can('view reports')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
                'title' => 'Reports',
        ...
        <?php if(\Auth::user()->can('manage permissions')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
        ...
        <?php endif; ?>
        <?php if(\Auth::user()->can('view bank accounts')): ?>
            <?php echo $__env->make('components.sidebar.sidebar-dropdown', [
...
<?php /**PATH /home/chris-droid/Desktop/metro/metroberry-apis-v1.1.0/resources/views/components/sidebar/sidebar-nav.blade.php ENDPATH**/ ?>