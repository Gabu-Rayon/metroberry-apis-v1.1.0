                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="fs-17 fw-semi-bold mb-0">Incomes</h6>
                                        <div class="actions">
                                        ...
                                        <table class="table">
                                            ...
                                            <?php $__currentLoopData = $incomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($income->entry_date); ?></td>
                                                    <td><?php echo e($income->description); ?></td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <?php if(\Auth::user()->can('edit expense')): ?>
                                                                <a href="<?php echo e(route('expenses.edit', $income->id)); ?>" class="btn btn-primary btn-sm mr-1" title="Add Remark">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/incomes/index.blade.php ENDPATH**/ ?>