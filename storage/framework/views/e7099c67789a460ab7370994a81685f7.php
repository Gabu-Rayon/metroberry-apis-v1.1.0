    ...
    <div class="col-xs-12 col-sm-12 remaining-height">
        ...
        <div class="change-request-status">
                                            ...
                                            <span class="#">
                                                <img id="national-id-front-preview"
                                                    src="<?php echo e($driver->national_id_front_avatar
                                                                ...
                                                                : asset('mobile-app-assets/icons/photocamera.svg')); ?>" alt="National ID Front" />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="#">
                                                <img id="national-id-back-preview"
                                                    src="<?php echo e($driver->national_id_behind_avatar
                                                                ...
                                                                : asset('mobile-app-assets/icons/photocamera.svg')); ?>" alt="National ID Back" />
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="request-notification-container map-notification meters-left-450 map-notification-warning">
                ...
                <form action="<?php echo e(route('driver.add.license')); ?>" method="POST"
                    enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="first_date_of_issue" name="first_date_of_issue" class="form-control"
                            value="<?php echo e(old('first_date_of_issue')); ?>" required>
                    </div>
                    <div class="mb-3">
                                            ...
                                            <span class="#">
                                                <img id="national-id-front-preview"
                                                    src="<?php echo e($driver->driverLicense && $driver->driverLicense->driving_license_avatar_front
                                                                ...
                                                                : asset('mobile-app-assets/icons/photocamera.svg')); ?>" alt="License Front Avatar" />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <span class="#">
                                                <img id="national-id-back-preview"
                                                    src="<?php echo e($driver->driverLicense && $driver->driverLicense->driving_license_avatar_back
                                                                ...
                                                                : asset('mobile-app-assets/icons/photocamera.svg')); ?>" alt="License Back Avatar" />
                            ...
                            <div class="display-flex justify-content-between">
                                <span class="position-relative upload-btn">
                                    ...
                                    <input class="scan-prompt" type="file" accept="image/*" name="badge_copy"
                                        value="<?php echo e(old('badge_copy')); ?>" required
                                        id="national-id-back-input" />
                                </span>
                                            ...
                                            <span class="#">
                                                <img id="national-id-back-preview"
                                                    src="<?php echo e($driver->psvBadge && $driver->psvBadge->psv_badge_avatar
                                                                ...
                                                                : asset('mobile-app-assets/icons/photocamera.svg')); ?>" alt="PSV Badge Avatar" />
...
const psvBadgeVerified =
    "<?php echo e($driver->psvBadge ? ($driver->psvBadge->verified ? 'true' : 'false') : 'false'); ?>";
