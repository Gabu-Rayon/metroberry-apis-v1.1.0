                                                                    ...
                                                                    <div class="d-flex gap-2">
                                                                        <?php if(\Auth::user()->can('edit role')): ?>
                                                                            <a href="javascript:void(0);"
                                                                                onclick="axiosModal('role/<?php echo e($role->id); ?>/edit')"
                                                                        ...
                                                                        <?php if(\Auth::user()->can('delete role')): ?>
                                                                            <a href="javascript:void(0);"
                                                                                onclick="axiosModal('role/<?php echo e($role->id); ?>/delete')"
                                                                                class="btn btn-danger btn-sm">
                                                                                <i class="fa fa-trash fa-sm"></i>
                                                                            </a>
                                                                        <?php endif; ?>
                                                                        <?php if(\Auth::user()->can('assign permission')): ?>
                                                                            <a href="javascript:void(0);"
                                                                                onclick="axiosModal('role/<?php echo e($role->id); ?>/permissions')"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kknuicdz/metroBerry/resources/views/role/index.blade.php ENDPATH**/ ?>