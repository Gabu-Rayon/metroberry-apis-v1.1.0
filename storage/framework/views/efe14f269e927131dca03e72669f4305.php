            ...
            <div class="rest-container">
                <div class="text-center header-icon-logo-margin header-icon-logo-margin-extra">
                    <div class="profile-picture-container">
                        <img src="<?php echo e(asset('mobile-app-assets/images/driver-registration.svg')); ?>" alt="Driver Registration Icon" />
                    </div>
                </div>
                ...
                <div class="sign-up-form-container">
                    <div class="width-100">
                        ...
                        <div class="border-bottom-primary">
                            <a href="<?php echo e(route('driver.license.document')); ?>" class="home-options-list href-decoration-none">
                                ...
                                <span class="icon choose float-right">
                                    <img src="<?php echo e(asset('mobile-app-assets/icons/angle-right.svg')); ?>" alt="Angle Right Icon" />
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="border-bottom-primary">
                            <a href="<?php echo e(route('personal.id.card.document')); ?>" class="home-options-list href-decoration-none">
                                Personal ID Card
                                <span class="fas fa-check icon chosen hidden"></span>
                                <span class="icon choose float-right">
                                    <img src="<?php echo e(asset('mobile-app-assets/icons/angle-right.svg')); ?>" alt="Angle Right Icon" />
...
<?php echo $__env->make('layouts.mobile-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/chris-droid/Desktop/metro/metroberry-apis-v1.1.0/resources/views/driver-app/driver-registration.blade.php ENDPATH**/ ?>